...
public class Credits implements ActionListener {
	...
	public void creditsGUI() {
		...
		var1.setForeground(color.three);
		...
		var2.setForeground(color.three);
		...
		var3.setForeground(color.three);
		...
		var4.setForeground(color.three);
		...
		var5.setForeground(color.three);
		...
		var6.setForeground(color.three);
		...
		var8.setForeground(color.three);
		...
		var9.setForeground(color.three);
		...
		var10.setForeground(color.three);
		...
		var11.setForeground(color.three);
		...
		var12.setForeground(color.three);
		...
		var13.setForeground(color.three);
		...
		var14.setForeground(color.three);
		...
		var16.setForeground(color.three);
		...
		var17.setForeground(color.three);
